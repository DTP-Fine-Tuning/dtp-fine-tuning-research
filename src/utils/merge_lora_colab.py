...
ADAPTER_PATH = "dtp-fine-tuning/multi-turn_chatbot_diploy"  # or "./checkpoint-350"

# Base model (leave None to auto-detect from adapter_config.json)
BASE_MODEL = None  # or "aitfindonesia/Bakti-8B-Base"
