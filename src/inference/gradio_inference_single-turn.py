#gradio interface script for agq question
    ...
    def generate_response(
        ...
        if stream:
            ...
            for new_text in self.streamer:
                ...
                #then only check if stop string appears near the end
                should_stop = False
