"""
multi turn training script for ur models with unsloth approach
...
def create_trainer(model, tokenizer, train_dataset, eval_dataset, config: dict):
    ...
    # Create formatting function that returns text directly
    # This is the key - we return the text as a string, not a list
